...
function drawEditProfileForm($user, ?FreeLancer $freelancer, array $errors): void { 
    $isFreelancer = $freelancer !== null;
?>
<main class="form-page">
    ...
    <?php if ($isFreelancer): ?>
      <label> Headline <textarea name="headline" maxlength="200" required><?= htmlspecialchars($freelancer->headline) ?></textarea> </label>
      <label> Description <textarea name="description" maxlength="1000" required><?= htmlspecialchars($freelancer->description) ?></textarea> </label>
    <?php endif; ?>
